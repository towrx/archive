...
const BASE_URL = "https://raw.githubusercontent.com/vuminhthanh12/vuminhthanh12/refs/heads/main/vmttv";
...
function getClearKey(html, licenseKey) {
  ...
  try { // clearKey needs to be fetched.
    ...
    console.log("ℹ️ [getClearKey in vmttv_plugin.js] clearKey NEEDS to be fetched - ", keyData);
    ...
    console.log("ℹ️ [getClearKey in vmttv_plugin.js] clearKey does NOT require fetching - ", licenseKey);
